                ...
                color: Colors.white.withOpacity(0.8),
                  ...
                  child: Padding(
                    ...
                    children: [
                      ...
                      SizedBox(height: 10.0),
                      Text(
                        'To be the leading travel company that offers unique and unforgottable travel experiences across the globe.',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: 16.0,
                        ),
                ...
                color: Colors.white.withOpacity(0.8),
                  ...
                  child: Padding(
                    ...
                    children: [
                      ...
                      SizedBox(height: 10.0),
                      Text(
                        'We offer a wide range of travel services including guided tours, customized travel itineraries, travel insurance, and more. whether you are looking for adeventure, relaxation, or cultural experiences, we have something for everyone.',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: 16.0,
                        ),
